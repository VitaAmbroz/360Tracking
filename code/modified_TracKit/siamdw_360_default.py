...
class SiamDW360Default:
    """Default tracking using SiamDW tracker"""
    ...
    def run_siamdw_default(self):
        """Method for start SiamDW tracking without any modifications"""
        # prepare tracker
        info = edict()
        info.arch = self.arch
    ...
    def _track_video(self, siam_tracker, siam_net):
        ...
        print("--------------------------------------------------------------------")
        print("SiamDW default tracking process has started...")
