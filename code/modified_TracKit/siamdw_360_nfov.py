...
# Module:       siamdw_360_nfov.py
# Description:  Default tracking using SiamDW tracker
#################################################################################################
# ------------------------------------------------------------------------------
...
class SiamDW360NFOV:
    """Tracking using SiamDW with normal field of view (rectilinear) improvement"""
    def __init__(self, resume: str, video_path: str, groundtruth_path: str = None, save_result_path: str = None):
        ...
        self.WINDOW_NAME_RECTILINEAR = "Tracker-SiamDW-frame_rectilinear"
    ...
    def run_siamdw_nfov(self):
        """Method for start SiamDW tracking with improvement of mapping equirectangular to rectilinear projection"""
        # prepare tracker
        info = edict()
        info.arch = self.arch
    ...
    def _track_video(self, siam_tracker, siam_net):
        ...
        print("--------------------------------------------------------------------")
        print("SiamDW tracking process with rectilinear improvement has started...")
